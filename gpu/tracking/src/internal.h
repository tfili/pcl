...
namespace pcl
{
	namespace device
	{
		...
		struct float8 {	double	x, y, z, w, roll, pitch, yaw, weight;	};	
		...
		void 
			...
			DeviceArray<double>& initial_noise_mean, DeviceArray<double>& initial_noise_covariance,
		...
		void 
			...
			PtrSz<curandState> rng_states, const DeviceArray<double>& step_noise_covariance,
			DeviceArray<StateType>& particles,
			StateType& representative_state, StateType& motion, double motion_ratio );
		
		/*
		void
			resample (StateXYZ& motion_xyz, StateRPY& motion_rpy, double motion_ratio,
			int num_particles, PtrSz<StateXYZ>& particles_xyz_, PtrSz<StateRPY>& particles_rpy_, PtrSz<double>& particles_weight_);
		void
			...
			int num_particles, PtrSz<StateXYZ>& particles_xyz_, PtrSz<StateRPY>& particles_rpy_, PtrSz<double>& particles_weight_);
		void
			update (int num_particles, PtrSz<StateXYZ>& particles_xyz_, PtrSz<StateRPY>& particles_rpy_, PtrSz<double>& particles_weight_, 
