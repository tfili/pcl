...
const double rej_dist_max_dist = 0.01;
...
const double rej_median_factor = 0.5;
const double rej_median_distance = 0.000465391;
...
const Eigen::Quaterniond   R_ref = Eigen::Quaterniond (.9, .1, -.25, .15).normalized ();
const Eigen::Translation3d t_ref = Eigen::Translation3d (.5, -2., 1.);
const Eigen::Affine3d      T_ref = Eigen::Affine3d (t_ref * R_ref);

const double transform_from_SAC[4][4] = {
  { 0.948507, -0.0486455, -0.312997, 0.0176326 },
  { 0.0276543f, 0.997081, -0.0711611, 0.00672534f },
  { 0.315546, 0.0588411, 0.947084f, 0.00613246 },
  { 0.0, 0.0, 0.0, 1.0 }
};

//const double transform_from_SVD[4][4] = {
//  { 0.973177, -0.0808924f, -0.215366, 0.0155407 },
//  { 0.0824616, 0.996593f, -0.0017039, 0.00217915 },
//  { 0.21477, -0.0161013f, 0.976532f, 0.00908635 },
//  { 0.0, 0.0, 0.0, 1.0 }
//};

//const double transform_from_LM[4][4] = {
//  { 0.973034f, -0.00984137, -0.230452f, 0.0102057 },
//  { 0.0343427, 0.994135, 0.10255, -0.00631323f },
